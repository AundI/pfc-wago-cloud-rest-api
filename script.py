...
myDeviceId= "eef37996-a765-4715-86ed-99753befe417"
myTagKey = "temperature"
myGroupKey = "1"
myStartDate = "2019-05-31T08:00:00.000Z"
...
#print("ret_link_data_export_d_h.text)
myvalues= json.loads(ret_link_data_export_d_h.text)

print(myvalues["result"]["values"])
